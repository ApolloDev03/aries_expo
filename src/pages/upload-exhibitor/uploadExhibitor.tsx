...
export default function UploadExhibitor() {
    ...
    const handleUpload = async () => {
        ...
        if (!businessTypeId) return toast.error("Please select Business Type");
        if (!categoryId) return toast.error("Please select Category");
        if (!subCategoryId) return toast.error("Please select Sub Category");
        ...
        try {
            ...
            form.append("business_type_id", businessTypeId);

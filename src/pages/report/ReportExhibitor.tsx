...
//     //         const dataRows = res.data?.data || res.data?.result || [];
//     //         console.log(dataRows, "listing=====")
//     //         const list: SubcategoryItem[] = (Array.isArray(dataRows) ? dataRows : [])
//     //             .map((r: any) => ({
//     //                 id: pickId(r),
//     //                 industry_subcategory_name: pickName(r),
//     //             }))
//     //             .filter((x) => x.id && x.industry_subcategory_name);
//     //         setSubcategoryOptions(list);
//     //     } catch (error: any) {
//     //         console.error(error);
//     //         setSubcategoryOptions([]);
...
//                         r?.id ??
//                         r?.subcategory_id ??
//                         r?.industry_subcategory_id ??
//                         ""
//                     ),
//                     industry_subcategory_name: String(
//                         r?.industry_subcategory_name ??
//                         r?.subcategory_name ??
//                         r?.name ??
//                         r?.title ??
//                         ""
...
//     console.log(subcategoryOptions, "subcategoryOptionssubcategoryOptionssubcategoryOptions")
//     return (

        ...
        return [
            {
                ...
                listingLink: "/admin/visitor-listing/total-visitor",
            ...
            },
            {
                ...
                listingLink: "/admin/visitor-listing/todays-visitor",
                usersLink: "/admin/user-wise/TodaysVisitor",
            },
            {
                label: "Today Exhibitors",
                value: n(d?.today_exhibitors),
                border: "border-green-500",
                listingLink: "/admin/visitor-listing/todays-exhibitor",
            ...
            },
            {
                ...
                listingLink: "/admin/visitor-listing/total-exhibitor",
                usersLink: "/admin/user-wise/TotalExhibitor",
            },
            {
                label: "Total Expected Exhibitors",
                value: n(d?.total_Expected_Exhibitors),
                border: "border-[#A65C50]",
                listingLink: "/admin/visitor-listing/total-expected-exhibitor",
                usersLink: "/admin/user-wise/TotalExpectedExhibitor",
            },
            {
                label: "Today Expected Exhibitors",
                value: n(d?.today_Expected_Exhibitors),
                border: "border-purple-500",
                listingLink: "/admin/visitor-listing/todays-expected-exhibitor",
